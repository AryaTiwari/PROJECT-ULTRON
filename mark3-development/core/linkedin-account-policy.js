...
function settings() {
  return {
    ...
    minGapMs: numberSetting('ULTRON_M3_LINKEDIN_MIN_GAP_MS', 6000, 5000, 60000),
    jitterMs: numberSetting('ULTRON_M3_LINKEDIN_JITTER_MS', 1200, 0, 15000),
    burstMax: numberSetting('ULTRON_M3_LINKEDIN_BURST_MAX', 12, 2, 12),
    burstWindowMs: numberSetting('ULTRON_M3_LINKEDIN_BURST_WINDOW_MS', 8 * 60 * 1000, 5 * 60 * 1000, 30 * 60 * 1000),
    hourlyMax: numberSetting('ULTRON_M3_LINKEDIN_HOURLY_MAX', 28, 2, 30),
    dailyMax: numberSetting('ULTRON_M3_LINKEDIN_DAILY_MAX', 90, 5, 120),
