...
module.exports = {
  ...
  // This must be the key generated by OmniRoute Dashboard -> Endpoints.
  // Provider keys (NVIDIA, Gemini, OpenRouter, etc.) are not interchangeable with it.
  ...
  // Mark 3 diagnostics: concrete OmniRoute model IDs only; Big Pickle disabled.
