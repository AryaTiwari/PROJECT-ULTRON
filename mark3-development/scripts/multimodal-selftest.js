...
assert(appIndex >= 0 && voiceIndex > appIndex && filesIndex > voiceIndex, 'Native voice and attachment wrappers must load after the main interface in the intended fetch-chain order.');
...
console.log('ULTRON multimodal self-test passed: PDF/DOCX rendering, natural artifact intents, attachments, native-audio transcription bridge and quota-safe passive Model League validated.');
