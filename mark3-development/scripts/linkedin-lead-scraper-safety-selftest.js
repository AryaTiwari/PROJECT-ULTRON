...
assert.equal(operator.apolloStatusForValues('https://www.linkedin.com/in/test', '12', 'a@b.com'), 'EMAIL_FOUND', 'Numeric junk must not count as an Apollo phone or produce ENRICHED.');
assert.equal(operator.apolloStatusForValues('https://www.linkedin.com/in/test', '+919876543210', '12'), 'PHONE_FOUND', 'Numeric junk must not count as an Apollo email or produce ENRICHED.');
