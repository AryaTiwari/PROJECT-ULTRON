...
{name:"ultron_google_workspace_auth_url",description:"Legacy compatibility alias. Use ultron_google_workspace_connect; ULTRON now opens a safe ephemeral loopback OAuth flow automatically.",inputSchema:{type:"object",properties:{services:{type:"string"}}},annotations:{readOnlyHint:false,destructiveHint:false,idempotentHint:false,openWorldHint:true}},
{name:"ultron_google_workspace_auth_code",description:"Legacy compatibility status tool. Manual auth-code handling is no longer required; use ultron_google_workspace_connect.",inputSchema:{type:"object",required:["codeOrUrl"],properties:{codeOrUrl:{type:"string"}}},annotations:{readOnlyHint:false,destructiveHint:false,idempotentHint:false,openWorldHint:true}},
