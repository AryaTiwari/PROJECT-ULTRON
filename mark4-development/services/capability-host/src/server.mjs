...
{name:"ultron_google_workspace_auth_url",description:"Legacy alias for the safe Google Workspace connect flow. ULTRON opens a secure ephemeral loopback callback automatically.",inputSchema:{type:"object",properties:{services:{type:"string"}}},annotations:{readOnlyHint:false,destructiveHint:false,idempotentHint:false,openWorldHint:true}},
